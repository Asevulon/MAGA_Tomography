...
// MAGA_Tomography.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMAGATomographyApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMAGATomographyApp

CMAGATomographyApp::CMAGATomographyApp()
{
...
// Единственный объект CMAGATomographyApp

CMAGATomographyApp theApp;


// Инициализация CMAGATomographyApp

BOOL CMAGATomographyApp::InitInstance()
{
